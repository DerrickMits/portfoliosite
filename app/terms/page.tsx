          ...
          <nav className="mb-8 text-sm text-warm-500 dark:text-warm-400" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2">
              ...
              <li aria-current="page">
                <span className="text-warm-900 dark:text-warm-100 font-medium">Terms and Conditions</span>
              </li>
            </ol>
          </nav>
          <header>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <article className="prose prose-zinc max-w-none dark:prose-invert prose-img:rounded-xl prose-headings:text-warm-900 dark:prose-headings:text-warm-100 prose-body:text-warm-700 dark:prose-body:text-warm-300 prose-links:text-warm-900 dark:prose-links:text-amber-400 prose-bold:text-warm-900 dark:prose-bold:text-warm-100 prose-code:text-warm-900 dark:prose-code:text-warm-100 prose-pre:bg-warm-100 dark:prose-pre:bg-warm-800 prose-pre:code:text-warm-900 dark:prose-pre:code:text-warm-100 prose-hr:border-warm-200 dark:prose-hr:border-warm-700 prose-quote:border-l-warm-300 dark:prose-quote:border-l-warm-600 prose-ul:marker:text-warm-400 dark:prose-ul:marker:text-warm-500">
            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">1. Acceptance of Terms</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-4">
                By accessing or using this website, including our portfolio, article library, resource hub, and consulting services (accessible via <code className="bg-[#E4E2DC] dark:bg-warm-700 px-1.5 py-0.5 rounded text-sm font-mono text-warm-900 dark:text-warm-100">/architect</code>), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please discontinue use of the site immediately.
              </p>
            </section>

            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">2. Intellectual Property & Permitted Use</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-4">
            ...
            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">3. Advisory & Consulting Disclaimer</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-4">
              ...
              <ul className="list-disc list-inside space-y-3 text-warm-700 dark:text-warm-300 leading-relaxed">
                ...
                <li>Engagement in consulting sprints or discovery calls via the <code className="bg-[#E4E2DC] dark:bg-warm-700 px-1.5 py-0.5 rounded text-sm font-mono text-warm-900 dark:text-warm-100">/architect</code> portal does not create an ongoing fiduciary liability beyond the terms outlined in a dedicated Statement of Work (SOW).</li>
              </ul>
            </section>

            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">4. User Submissions & Form Inquiries</h2>
            ...
            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">5. Third-Party Integrations & External Links</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed">
            ...
            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">6. Limitation of Liability</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed">
            ...
            <section className="mb-12 pb-8 border-b border-warm-200 dark:border-warm-700">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">7. Governing Law</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-display font-bold text-warm-900 dark:text-warm-100 mb-4">8. Contact Information</h2>
              <p className="text-warm-700 dark:text-warm-300 leading-relaxed mb-4">
